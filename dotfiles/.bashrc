...
# Setup fzf
# ---------
if [[ ! "$PATH" == */home/agonzalez/.fzf/bin* ]]; then
  export PATH="$PATH:/home/agonzalez/.fzf/bin"
fi

# Auto-completion
# ---------------
[[ $- == *i* ]] && source "/home/agonzalez/.fzf/shell/completion.bash" 2> /dev/null

# Key bindings
# ------------
source "/home/agonzalez/.fzf/shell/key-bindings.bash"
